...
def parse_args_and_config():
    ...
    parser.add_argument('--miu_path', type=str, default='./images/blue_noise_rgb.png')
    parser.add_argument('--total_n_samples', type=int, default=50000)

    args = parser.parse_args()
    args.trigger_type = 'blend'

    args.exp = os.path.join('./instanceData/ddpm_attack',
    ...
    args.checkpoint_path = os.path.join(args.exp, "checkpoints", args.doc)
    args.verbose = 'info'
